...
const baseURL = 'http://localhost:8080/ProjectsManagement-Back-end/ProjectRest';
...
const updateProject = async (codeProject , newStartDay , newDescription) => {
  try {
    const response = await axiosInstance.patch(`/update/${codeProject}/${newStartDay}/${newDescription}`);
    console.log('Response:', response); 
    if (response.status === 200) {
